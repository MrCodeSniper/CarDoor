...
public class CustomGroup extends ViewGroup {
	...
	private ArrayList<DragIconInfo> initAllOriginalInfo() {
		...
		iconInfoList.add(new DragIconInfo(1, "帮选车", R.drawable.toutiao__qctt_home_ic_xxxc, DragIconInfo.CATEGORY_ONLY, new ArrayList<DargChildInfo>()));
		iconInfoList.add(new DragIconInfo(2, "车友问答", R.drawable.toutiao__qctt_home_ic_ywbd, DragIconInfo.CATEGORY_ONLY, new ArrayList<DargChildInfo>()));
		iconInfoList.add(new DragIconInfo(3, "证件识别", R.drawable.toutiao__qctt_home_ic_cjzjf, DragIconInfo.CATEGORY_ONLY, new ArrayList<DargChildInfo>()));
		iconInfoList.add(new DragIconInfo(4, "实时停车", R.drawable.toutiao__qctt_home_ic_sgcl, DragIconInfo.CATEGORY_ONLY, new ArrayList<DargChildInfo>()));
		iconInfoList.add(new DragIconInfo(8, "晒晒照", R.drawable.toutiao__qctt_home_ic_ktcc, DragIconInfo.CATEGORY_ONLY, new ArrayList<DargChildInfo>()));
		iconInfoList.add(new DragIconInfo(6, "违章咨询", R.drawable.toutiao__qctt_home_ic_cwz, DragIconInfo.CATEGORY_ONLY, new ArrayList<DargChildInfo>()));
		iconInfoList.add(new DragIconInfo(7, "维修保养", R.drawable.toutiao__qctt_home_ic_acby, DragIconInfo.CATEGORY_ONLY, new ArrayList<DargChildInfo>()));
		iconInfoList.add(new DragIconInfo(5, "万能计算器", R.drawable.toutiao__qctt_home_ic_gcjsq, DragIconInfo.CATEGORY_EXPAND, childList));
		iconInfoList.add(new DragIconInfo(9, "车险理赔", R.drawable.toutiao__qctt_home_ic_wymc, DragIconInfo.CATEGORY_ONLY, new ArrayList<DargChildInfo>()));
	...
	private ArrayList<DargChildInfo> initChildList() {
		...
		childList.add(new DargChildInfo(1, "购车计算器"));
		childList.add(new DargChildInfo(2, "车贷计算器"));
		childList.add(new DargChildInfo(3, "车险计算器"));
		return childList;
	}
	/**
	 *
	...
	private void judeHomeInfoValid() {
		...
		if(!hasMoreInfo){
			//没有更多 增加
			homePageInfoList.add(new DragIconInfo(CustomAboveView.MORE, "更多", R.drawable.toutiao__qctt_home_ic_more, 0, new ArrayList<DargChildInfo>()));
		}else{
	...
	public void sendEventBehind(MotionEvent ev) {
		Log.e("tazzz","sendeventbehind");
		mCustomBehindParent.childDispatchTouchEvent(ev);
	}

	@Override
	public boolean dispatchTouchEvent(MotionEvent ev) {
		Log.e("tazzz","customGroup---dispatchTouch");
